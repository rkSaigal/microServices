...
import com.lcwd.user.user.service.config.interceptor.RestTemplateInterceptor;
//import interceptor.RestTemplateInterceptor;
...
public class MyConfig {
    ...
    @Bean
    @LoadBalanced               //when more than one instances then distribute the load
